...
extern "C"  void SD_WriteBufferToLine(unsigned char* pBuf , int lenght );
extern "C"  bool SD_ReadResponse(unsigned char* pBuf , int lenght , int timeout );
extern "C"  bool SD_ReadData(unsigned char* pBuf , int lenght , int timeout );
extern "C"  void SD_WriteData(unsigned char* pBuf , int lenght , int timeout );
extern "C"  unsigned char crc_730(unsigned char *ptr,unsigned char len) ;
